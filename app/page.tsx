    ...
    <main className="flex min-h-screen flex-col items-center justify-center p-24 bg-black text-white">
      <div className="text-center">
        ...
        <div className="flex flex-col md:flex-row gap-4 justify-center">
          ...
          <Link href="/overlapping-video" className="bg-purple-600 hover:bg-purple-700 text-white font-bold py-3 px-6 rounded-lg text-lg transition-colors">
              Overlapping Video Analysis
          </Link>
        </div>
      </div>

      <div className="mt-16 text-left max-w-4xl w-full">
        <h2 className="text-3xl font-bold mb-6 text-center tracking-wider text-gray-200 uppercase">HOW TO USE</h2>
        <div className="mb-8">
          <h3 className="text-lg font-semibold mb-2 text-blue-400">1. Select Videos:</h3>
        ...
        <div className="mb-8">
          <h3 className="text-lg font-semibold mb-2 text-blue-400">2. Align Videos for Analysis:</h3>
          <p className="text-gray-300 text-sm leading-relaxed">
        ...
        <div className="mb-8">
          <h3 className="text-lg font-semibold mb-2 text-blue-400">3. Viewing Functions:</h3>
          <p className="text-gray-300 text-sm leading-relaxed">
