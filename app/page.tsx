  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-24 bg-black text-white">
      ...
      <div className="mt-16 text-left max-w-4xl w-full">
        <div className="mb-8">
          <h3 className="text-2xl font-semibold mb-2">1. Select Videos:</h3>
        ...
        <div className="mb-8">
          <h3 className="text-2xl font-semibold mb-2">2. Align Videos for Analysis:</h3>
          <p className="text-gray-300">
        ...
        <div className="mb-8">
          <h3 className="text-2xl font-semibold mb-2">3. Viewing Functions:</h3>
          <p className="text-gray-300">
