  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-start p-12 bg-black text-white">
      ...
      <div className="mt-16 text-left max-w-4xl w-full">
        <h2 className="text-3xl font-bold mb-6">How to Use This Site</h2>

        <div className="mb-8">
          <h3 className="text-2xl font-semibold mb-2">Selecting Videos:</h3>
        ...
        <div className="mb-8">
          <h3 className="text-2xl font-semibold mb-2">Aligning Videos for Analysis:</h3>
          <p className="text-gray-300">
        ...
        <div>
          <h3 className="text-2xl font-semibold mb-2">Viewing Functions:</h3>
          <p className="text-gray-300">
